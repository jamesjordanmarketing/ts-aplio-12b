        ...
        <div className="col-span-12 md:col-span-8 1xl:pl-[120px]">
          <div className="relative z-10">
            ...
            <div className="absolute left-1/2 top-1/2 -z-10 flex -translate-x-1/2 -translate-y-1/2 max-sm:hidden">
              <div className="h-[330px] w-[330px] rounded-full bg-primary-200/20 blur-[145px] xl:h-[350px] xl:w-[350px]" />
              <div className="lg-ml-[170px] h-[330px] w-[330px] rounded-full bg-primary-200/20 blur-[145px] xl:h-[350px] xl:w-[350px]" />
            </div>

            {/* Services cards grid */}
            <div className="grid grid-cols-2 gap-8 max-md:grid-cols-1">
              {servicesCards.map(({ id, ...service }) => (
