...
import Link, { type RouteImpl } from 'next/link'

import { type FC, type PropsWithChildren, type ReactNode } from 'react'
import { type TeamMember } from '@/app/data/teamData'

interface SocialLinkProps {
  href: string | UrlObject | RouteImpl<string>
  children: ReactNode
}
...
const SocialLink: FC<SocialLinkProps> = ({ href, children }) => (
  <li>
    <Link
      href={href as RouteImpl<string> | UrlObject}
...
const SocialIcon: FC<PropsWithChildren<SocialIconProps>> = ({ children }) => (
  <svg
    width="40"
    height="40"
    viewBox="0 0 40 40"
    ...
    <div className="group/image">
      ...
      <div className="text-center">
        ...
        <ul className="flex items-center justify-center gap-x-2.5">
          ...
          <SocialLink href={member.dribbleInLink}>
            <SocialIcon>
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <SocialLink href={member.gitHubLink}>
            <SocialIcon>
              <path
          ...
          <SocialLink href={member.linkedInLink}>
            <SocialIcon>
              <path
